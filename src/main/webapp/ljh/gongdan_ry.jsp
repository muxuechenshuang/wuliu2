			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">工单状态</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryFlatformId" class="form-control">
									   <option value="">请选择</option>
									  	<option value="">已完成定单</option>
						...
						<li>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">工单编号</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<li>
							...
							<li>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">合包号</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input name="querySoftwareName" type="text"
										class="form-control col-md-7 col-xs-12"
										value="${querySoftwareName }">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/dev/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增工单基础信息</a>

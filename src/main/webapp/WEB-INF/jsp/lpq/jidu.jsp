...
<h3><a href="${pageContext.request.contextPath}/wuliu/biao">月度表</a>&nbsp;&nbsp;&nbsp;
    <a href="javascript:;">季度表</a>&nbsp;&nbsp;
    <a href="${pageContext.request.contextPath}/wuliu/biao3">年度表</a></h3>
<!-- 显示Echarts图表 -->
...
<script type="text/javascript">
    ...
    var option = {
        ...
        xAxis:  {	//X轴
            type : 'category',
            data : ['一季度','二季度','三季度','四季度']	//先设置数据值为空，后面用Ajax获取动态数据填入
        },
        ...
        series : [	//系列（内容）列表
            {
                ...
                data:[56,89,100,120]		//数据值通过Ajax动态获取
            },
        ]
    };
    ...
    $.ajax({	//使用JQuery内置的Ajax方法
        ...
        url : "jidu",	//请求发送到ShowInfoIndexServlet处

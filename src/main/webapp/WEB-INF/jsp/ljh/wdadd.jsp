            ...
            <div class="x_content">
                ...
                <form id="myForm" class="form-horizontal form-label-left"
                    ...
                    <div class="item form-group">
                        ...
                        <span id="checksite" style="position: relative; top: 7px;"></span>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="phone" class="form-control col-md-7 col-xs-12"
                                   name="phone" data-validate-length-range="20"
                                   data-validate-words="1" required="required"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="company" class="form-control col-md-7 col-xs-12"
                                   name="parentName" data-validate-length-range="20" value="${company.name}"

...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>查看网点信息<i class="fa fa-user"></i>
            ...
            <div class="x_content1">
                ...
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">网点简介 <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <c:choose>
                            <c:when test="${organization.introduction!=null || organization.introduction}!=''}">

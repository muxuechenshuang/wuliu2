...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
           <div class="clearfix"></div>
        <form id="form" class="form-horizontal form-label-left" action="appinfoaddsave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sPhone">电话： <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="sPhone" class="form-control col-md-7 col-xs-12"
              	data-validate-length-range="20" data-validate-words="1" name="sPhone"   required="required"
          ...
          <br>
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="rName">收件人：<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="rName" class="form-control col-md-7 col-xs-12"
              data-validate-length-range="20" data-validate-words="1" name="rName"   required="required"
              placeholder="请输入姓名" type="text">
            </div>
          </div>
           <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="rPhone">收件人电话：<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="rPhone" class="form-control col-md-7 col-xs-12"
              data-validate-length-range="20" data-validate-words="1" name="rPhone"   required="required"
              placeholder="请输入电话" type="text">
            </div>
          </div>
           <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="rAddress">收件人地址：<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="rAddress" class="form-control col-md-7 col-xs-12"
              data-validate-length-range="20" data-validate-words="1" name="rAddress"   required="required"
              placeholder="请输入地址" type="text">
            </div>
          </div>
             <br>
          ...
          <br>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              data-validate-length-range="20" data-validate-words="1" name="sTime"  readonly
          ...
          <div class="item form-group">
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cName">货物名称：<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="cName" class="form-control col-md-7 col-xs-12"
                           data-validate-length-range="20" data-validate-words="1" name="cName"   required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="sWeight" class="form-control col-md-7 col-xs-12" name="sWeight"
                       data-validate-length-range="20" data-validate-words="1"   required="required"
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sComment">对小哥说：
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="sComment" class="form-control col-md-7 col-xs-12"
              data-validate-length-range="20" data-validate-words="1" name="sComment"

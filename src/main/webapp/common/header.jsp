            ...
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="${pageContext.request.contextPath }/dev/flatform/main" class="site_title"><i
                            class="fa fa-paw"></i> <span>飞鸟物流</span>
                    </a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> 客户(任一)<span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/lixing/branchquery_ry.jsp">服务网点查询</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/lixing/moneyestimate_ry.jsp">运费时效查询</a>
                                    </li>
                            ...
                            <li><a><i class="fa fa-home"></i>分公司管理<span
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath}/filiale/wd/query">网点管理</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/ljh/kuaidiyuan_ry.jsp">快递员管理</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/ljh/addkuaidiyuan.jsp">新增快递员</a>
                                    </li>
                            ...
                            <li><a><i class="fa fa-home"></i>总公司管理<span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/zz/fanhuodanxiangqing_zz.jsp">审核返货单</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/zz/fengongsitianjia_zz.jsp">新增分公司</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/zz/fengongsichaxun_zz.jsp">分公司管理</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/zz/wangdianchaxun_zz.jsp">网点管理</a>
                                    </li>
